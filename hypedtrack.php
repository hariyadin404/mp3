...
$json=json_decode(ngegrab('http://ws.audioscrobbler.com/2.0/?method=chart.gethypedtracks&api_key=7df2ba528dcd0d495e3db6284ee6e1a3&format=json&limit=10&page='.$noPage.''));
if (!empty($json)){
